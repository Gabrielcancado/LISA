...
bridge = CvBridge()
gesture_mapping = {
    'Thumb_Up': 1, # Felizinha, mexer os braços
    'Thumb_Down': 2, # Triste, abaixar a cabeça + lobo pidão
    'Open_Palm': 3, #  Bombastic Side eye
    'Closed_Fist': 4, # Ingratidão, Abaixar a cabeça/orelhas
    'Victory': 5, # Estrelinha, mexer orelhas e base
    'Pointing_Up': 6, # Sapeca, mexe braços e base
}
